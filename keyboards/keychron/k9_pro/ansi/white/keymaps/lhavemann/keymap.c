...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_61_ansi(
        ...
        KC_LCTL,  KC_LOPTN, KC_LCMMD,                     LT(L_FN1, KC_SPC),                                 KC_RCMMD,MO(MAC_FN),MO(L_FN1),KC_RCTL),
    ...
    [L_FN1] = LAYOUT_61_ansi(
        ...
        _______,  _______,  EU_EUR,  _______,  _______,  _______,  _______,  LOPT(KC_U),  _______,  UML_OE,  _______,  _______,  _______,  _______,
        KC_CAPS,  _______, RALT(KC_S), KC_LBRC, RSFT(KC_LBRC),  RSFT(KC_9),  KC_LEFT,  KC_DOWN,  KC_UP,  KC_RIGHT,  _______, _______, _______,
